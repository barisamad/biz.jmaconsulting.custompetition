...
class CRM_Campaign_Form_Petition_Signature extends CRM_Core_Form {
  ...
  public function postProcess() {
    ...
    if ($this->_loggedIn) {
      ...
      $rule = CRM_Core_DAO::singleValueQuery("SELECT max(id) FROM civicrm_dedupe_rule_group WHERE name = 'Petition_Rule_23'");
      $ids = CRM_Contact_BAO_Contact::getDuplicateContacts($params, $this->_ctype, 'General', array(), FALSE, $rule);
    }
